...
if __name__ == "__main__":
    pass
    # elmer_simulation = ElmerSimulation()
    # material = ElmerMaterial()
    # material.data.update({'Density': 1e3})

    # elmer_simulation.materials.update({'material': material})
    # body = ElmerBody()
    # body.material = 'material'
    # elmer_simulation.bodies.update({'body': body})

    # elmer_simulation.write_sif('./', 'test.sif')
